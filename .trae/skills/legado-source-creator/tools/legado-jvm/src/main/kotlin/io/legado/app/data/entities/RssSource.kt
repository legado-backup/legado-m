...
// 简化说明：移除 Room 注解(@Entity/@PrimaryKey/@ColumnInfo/@Index)/Parcelable/@Parcelize/: BaseSource 继承/@JavascriptInterface，改为独立 Serializable POJO | 已知上限：失去 Room 持久化、Parcelable 高效序列化、BaseSource 的 77+ JS 扩展方法、WebView JS 注入接口 | 升级路径：需要 JS 执行时通过 AnalyzeRule 注入
