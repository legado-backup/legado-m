...
// 源码参照: app/src/main/java/io/legado/app/utils/HtmlFormatter.kt
// 简化说明: 完整移植真机 HtmlFormatter，唯一差异为 NetworkUtils -> NetworkUtilsStub | 已知上限: 无 | 升级路径: 无
        ...
        while (matcher.find()) {
            ...
            sb.append(
                keepImgHtml.substring(appendPos, matcher.start()), "<img src=\"${
                    NetworkUtilsStub.getAbsoluteURL(
                        redirectUrl,
                        matcher.group(1)?.let {
