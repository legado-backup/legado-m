...
// 源码参照: app/src/main/java/io/legado/app/help/ConcurrentRateLimiter.kt
// 修复 GAP-37: 移植完整限流实现，对齐真机 fetchStart/getConcurrentRecord 逻辑
// 简化说明: ConcurrentException 内联为私有类，delay 用 Thread.sleep 替代 | 已知上限: 无协程取消支持 | 升级路径: 接入协程

class ConcurrentRateLimiter(source: BaseSourceInterface?) {
    ...
    companion object {
        ...
        /**
         * 更新并发率
         * 源码参照: app/src/main/java/io/legado/app/help/ConcurrentRateLimiter.kt#L16-L46
         */
    ...
    /**
     * 内联 ConcurrentException，携带等待时间
     */
    private class ConcurrentException(message: String, val waitTime: Long) : RuntimeException(message)

    /**
     * 开始访问,并发判断
     * 源码参照: app/src/main/java/io/legado/app/help/ConcurrentRateLimiter.kt#L54-L98
     */
     ...
     * 源码参照: app/src/main/java/io/legado/app/help/ConcurrentRateLimiter.kt#L103-L111
     */
    suspend fun getConcurrentRecord(): ConcurrentRecord? {
        while (true) {
            try {
                ...
                kotlinx.coroutines.delay(e.waitTime)
            }
        }
    }
    ...
    /**
     * 阻塞式获取并发记录
     * 源码参照: app/src/main/java/io/legado/app/help/ConcurrentRateLimiter.kt#L113-L121
     */
