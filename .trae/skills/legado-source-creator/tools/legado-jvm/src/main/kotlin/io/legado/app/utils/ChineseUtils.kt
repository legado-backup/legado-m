...
import com.github.liuyueyi.quick.transfer.ChineseUtils as ThirdPartyChineseUtils
...
object ChineseUtils {
    ...
    fun s2t(content: String): String {
        return ThirdPartyChineseUtils.s2t(content)
    }
    ...
    fun t2s(content: String): String {
        ...
        return ThirdPartyChineseUtils.t2s(content)
    }

    fun preLoad(async: Boolean, vararg transType: TransType) {
        ThirdPartyChineseUtils.preLoad(async, *transType)
    }

    fun unLoad(vararg transType: TransType) {
        ThirdPartyChineseUtils.unLoad(*transType)
    }
    ...
    fun fixT2sDict() {
        ...
        ThirdPartyChineseUtils.loadExcludeDict(TransType.TRADITIONAL_TO_SIMPLE, excludeList)
    }
