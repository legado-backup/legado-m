...
class BookCharacterDangerTokenTest {

    private fun code(): String {
        val rel = "src/main/java/io/legado/app/ui/book/character/compose/BookCharacterComposeScreens.kt"
    ...
    fun dangerUsesSemanticSingleSource() {
        ...
        assertFalse("不得再写字面色值", t.contains("Color(0xffe34f4f"))
    }
}